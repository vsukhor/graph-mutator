...
#include "graph-mutator/transforms/vertex_split/functor_11.h"
#include "graph-mutator/transforms/vertex_split/functor_1B.h"
#include "graph-mutator/transforms/vertex_split/functor_13.h"
#include "graph-mutator/transforms/vertex_split/functor_BB.h"
...
template<unsigned D1,
         ...
         typename G>
struct VertexSplit
    : public graph_mutator::vertex_split::Functor<D1, D2, G> {

    explicit VertexSplit(G& graph)
        : graph_mutator::vertex_split::Functor<D1, D2, G> {graph}
    {}
};
